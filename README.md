...
- ✔ **Saisie rapide par client** — Matin, après-midi, clients multiples, tout s'organise en quelques touches
- ✔ **Mémoire intelligente** — L'app retient vos clients, intitulés et lieux pour une saisie quasi automatique
- ✔ **Calculs automatiques** — Totaux journaliers, hebdomadaires, pauses déductibles : zéro calcul manuel
- ✔ **Gestion des frais** — Transport, repas, fournitures — tout est suivi en même temps que les heures
- ✔ **Exports professionnels** — PDF et Excel prêts à envoyer, par semaine, par mois ou par client
- ✔ **Ultra-légère & hors ligne** — Moins de 100 Ko, fonctionne sans connexion, s'installe comme une app native
- ✔ **100 % privée** — Aucun compte, aucun serveur, toutes les données restent sur votre appareil
...
- 🛡 **Zéro transmission** — Aucun serveur externe, aucun tracking
- 📱 **Stockage local uniquement** — Vos données ne quittent jamais votre appareil
- 🔐 **Aucun compte requis** — Pas d'inscription, pas de mot de passe
...
## 👷 Adapté à de nombreux métiers

🔧 Électriciens, plombiers, menuisiers, peintres — 🛠 Techniciens, maintenance, informatique — 🏠 Services à domicile, jardinage, entretien — 🏥 Infirmiers, thérapeutes, accompagnement — 🎓 Formateurs, coachs, professeurs particuliers — 🚚 Chauffeurs, livreurs, coursiers — 🎥 Photographes, vidéastes, graphistes — 🐾 Pet sitters, éducateurs canins — 💼 Consultants, indépendants — 🛡 Surveillance, gardiennage
